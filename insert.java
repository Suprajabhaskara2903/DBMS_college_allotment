  ...
  public void buildGUI()
  {
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(exam_hall_no.getText().length() != 10){
			errorText.append("\nExam hall ticket number consists 10 digits");
			flag = 0;
		}
		if(flag==1) {
		try
		{
		   ...
		   firstname.getText() + "','" + lastname.getText() + "','" + dob.getText() + "','" +
		   grp.getSelectedCheckbox().getLabel()+ "','" + ph_no.getText() + "','" +choice.getSelectedItem()+ "','" +exam_hall_no.getText() + "','" +age.getText() + "'"  +")";
