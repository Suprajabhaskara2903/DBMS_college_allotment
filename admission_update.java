...
import java.sql.*;
public class admission_update extends Frame {
  ...
  public void buildGUI()
  {
	...
	updateStudentButton = new Button("Update Admission Details");
	...
	public void actionPerformed(ActionEvent e)
	{
		try
		{
		   String query= "update admission set college_name="+"'"+college_name.getText()+"' ,"+"date_of_enrollment="+"'"+date_of_enrollment.getText()+"' ,"+
	                 "branch_name="+"'"+choice.getSelectedItem()+"' "+"where stu_firstname="+"'"+firstname.getText()+"'"+" and stu_lastname="+"'"
			   +lastname.getText()+"'"+"";
