...
import java.sql.*;
public class admission_insert extends Frame {
  ...
  public void buildGUI()
  {
	...
	insertStudentButton = new Button("Insert Admission Details");
	...
	public void actionPerformed(ActionEvent e)
	{
		try
		{
		   ...
		   firstname.getText() + "','" + lastname.getText() + "','" + college_name.getText() + "','" +
		     date_of_enrollment.getText() + "','" +choice.getSelectedItem()+ "'"  +")";
